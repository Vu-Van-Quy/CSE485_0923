...
<div class="container-fluid">
    <div class="row">
            <div class="main-content vh-100 p-3">
                ...
                ?>
                <h3 class=" text-center text-uppercase">Sửa thông tin bênh nhân</h3>
                <form action="../controller/editController.php" method="post">
                    <div class="row input-group mb-3">
                        ...
                        <div class="col-md-8">
                            <input type="text" name="uid" id="" class="form-control " value="" readonly>
                        </div>
                    </div>
                    <div class="row input-group mb-3">
                        <div class="col-md-4 ">
                        ...
                        <div class="col-md-8">
                            <input type="text" name="user" id="" class="form-control " value="<?=$bn ?>" >
                        </div>
                    </div>
                    <div class="row input-group mb-3">
                        <div class="col-md-4 ">
