...
<body>
    <div class="container-fluid">
        <div class="row">
            ...
            <h3 class="text-center mx-5 w-3"><b>SỬA THÔNG TIN THỂ LOẠI</b></h3>
            <div class="row">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" placeholder="Thể loại"  aria-describedby="basic-addon1">
                </div>

                <div class="container ">
                    <div class="text-end">
                        <a href=""><button type="button" class="btn btn-success mt-5">Thêm</button></a>
                        <a href=""><button type="button" class="btn btn-warning mt-5">Quay lại</button></a>
                    </div>
                </div>
            </div>
            <div class="row"> 
